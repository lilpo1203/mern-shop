...
const OrderScreen = ({match,history}) => {
    ...
    return (
        <div>
            {loading ? <Loader></Loader> : error ? <Message variant='danger'>{error}</Message> : <div>
                        ...
                        <ListGroup variant ="flush">
                            ...
                            {!order.isPaid && (
                                <ListGroup.Item>
                                    ...
                                    {!sdkReady ? (<Loader></Loader>) : (<PayPalButton amount={order.totalPrice} onSuccess={successPaymentHandler}></PayPalButton>)}
                                </ListGroup.Item>
                            )}
